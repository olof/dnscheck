	...
	$translationMap = array(
		"en" => array(
			...
			<ol>
				...
				<li><a href="#f13">What kind of queries does DNSCheck generate?</a></li>
			</ol>
			<div class="divider"></div>
			<h5 id="f1">What is DNSCheck?</h5>

			<p>DNSCheck is a program created by .SE that was designed to help people check, measure and hopefully also understand the workings of the Domain Name System, DNS. When a domain is submitted to DNSCheck it will investigate the domain\'s general health by traversing the DNS from root (.) to the TLD (Top Level Domain) to eventually the name server(s) that holds the information about the specified zone. Some other sanity checks, for example measuring host connectivity and validity of IP-addresses, will also be performed.</p>
			...
			<p>In the example below we have clicked on the error with the title &ldquo;<strong>Name server ns2.rayceem.com (88.131.68.184) does not answer queries over UDP</strong>&rdquo;. After that the detailed information below became visible.</p>
			<p><a href="#findex">Back to the top </a></p>
			...
			<p><a href="#findex">Back to the top </a></p>
			<h5 id="f13">What kind of queries does DNSCheck generate?</h5>
